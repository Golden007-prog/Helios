...
We — the contributors and maintainers of Helios — pledge to make participation in our project a harassment-free experience for everyone, regardless of age, body size, disability, ethnicity, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
This Code of Conduct applies within all community spaces — the GitHub repository, issues, pull requests, discussion threads — and also applies when an individual is officially representing the community in public spaces (using an official email, posting via an official account, or acting as an appointed representative at an online or offline event).

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers at the email listed in `SUPPORT.md`. All complaints will be reviewed and investigated promptly and fairly.
